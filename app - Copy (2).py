...
def _is_style_code_valid(built_code: str, cs_list: list) -> bool:
    """Check if a style code is valid using the same matching logic as _lookup_client_style from ambition.py."""
...
def _check_missing_style_codes(df_list, cs_list):
